...
public class EdicionZonasGPS extends JFrame {
	...
	public EdicionZonasGPS() {
		...
		setSize( 1600, 1000 );
		setTitle( "Edición de zonas geoposicionadas (Erandio) - Examen resuelto" );
		...
		/** Dibuja un círculo negro en el mapa
		 * @param redibujaPant	Redibuja la pantalla antes de pintar el círculo (si es true) o pinta encima de lo que haya (false)
		...
		private void dragEn( Point p1, Point p2, boolean boton1  ) {
			if (tbZoom.isSelected()) {  // Zoom sobre drag tiene dos partes: mover al centro y escalar al rectángulo del drag (si no es demasiado pequeño)
				...
				// TAREA 6 - Parte 1. Calcular dos puntos más cercanos a arbolCerca - cálculos previos a la llamada recursiva
				// TAREA 6 - Parte 2. llamada recursiva (método a continuación)
			}
		}
			// TAREA 6 - Parte 2. Rutina recursiva
			private void mostrarPuntoMasCercano() {  // Por completar
			}
