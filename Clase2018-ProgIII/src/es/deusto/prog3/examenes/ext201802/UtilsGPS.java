...
public class UtilsGPS {
    ...
    /** Devuelve el área aproximada de una zona GPS marcada por sus puntos exteriores
     * @param subzonaGPS	Lista de puntos de la zona
     * @return	Área aproximada, en la escala de los puntos GPS
     */
    ...
    /** Devuelve el área aproximada de la interseccion de subzonas GPS marcadas por sus puntos exteriores
     * @param zonasGPS	Lista de listas de puntos (subzonas gps)
     * @return	Área aproximada del área común de esas subzonas. Si no hay coincidencia, devuelve 0.0
     */
    public static double interseccionEntrePoligonos( ArrayList<ArrayList<PuntoGPS>> zonasGPS ) {
    	...
    	// Métodos privados para el cálculo de áreas
