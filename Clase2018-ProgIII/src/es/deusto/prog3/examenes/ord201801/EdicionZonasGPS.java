...
import es.deusto.prog3.examenes.ord201801.item.Arbol;
...
public class EdicionZonasGPS extends JFrame {
	...
	double zoomX = 1.0;         // A cuántos pixels de pantalla corresponden los pixels del gráfico en horizontal. 2.0 = aumentado. 0.5 = disminuido
	double zoomY = 1.0;         // En vertical
	double offsetX = 0.0;       // Qué píxel x de pantalla marca el origen del gráfico
	double offsetY = 0.0;       // Qué píxel y de pantalla marca el origen del gráfico
